...
const Head = () => {
  ...
  useEffect(() => {
    ...
    //but if the difference between 2api call is <200ms
  ...
  return (
    <div className="grid grid-flow-col p-1 m-1 shadow-lg">
      ...
      <div className="col-span-10 px-10 py-2 relative">
        <div>
          <input
        ...
        {showSuggestions && (
          <div className="absolute bg-white py-2 px-3 w-[38rem] shadow-lg rounded-lg border border-gray-100">
            <ul>
              {suggestions.map((s) => (
      ...
      <div className="col-span-1 flex text-3xl gap-10 py-4">
        <RiVideoAddLine />
        <BsBell />
        <img
          className="h-8"
